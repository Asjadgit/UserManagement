                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="frequency" class="form-control">
                                            <option value="week" {{ old('frequency') == 'week' ? 'selected' : '' }}>Weekly
                                            </option>
                                            <option value="month" {{ old('frequency') == 'month' ? 'selected' : '' }}>
                                                Monthly</option>
                                            <option value="year" {{ old('frequency') == 'year' ? 'selected' : '' }}>Yearly
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="features[]" class="form-control"
                                            value="{{ old('features.0') }}" placeholder="Enter a feature">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="features[]" class="form-control mt-2"
                                            value="{{ old('features.1') }}" placeholder="Enter another feature">
                                    </div>
                                </div>
                            </div>
